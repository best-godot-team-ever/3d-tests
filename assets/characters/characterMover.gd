...
export var move_accel = 4         # Movement aceleration
export var max_speed = 25         # Max movement speed
var drag = 0.5                    # Drag value
export var gravity = 60           # Gravity multiplier
export var jump_force = 30        # force of the jump
var move_vec : Vector3            # Movement vector
var velocity : Vector3            # Body velocity
var snap_vec : Vector3 
var pressed_jump = false           # If the jump command was pressed
export var ignore_rotation = false # Use aways global coordinates.
var frozen = false                 # Dies (freeze into place)
signal movement_info               # Signal for taking info from the movement 
